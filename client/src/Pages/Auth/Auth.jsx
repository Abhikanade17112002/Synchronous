      ...
      <div className="rounded-3xl grid items-start xl:grid-cols-2 h-[80vh] no-scrollbar overflow-y-auto scroll-smooth border-2 border-white text-opacity-90 shadow-2xl w-[80vw]  md:w-[90vw] lg:w-[70vw] xl:w-[70vw]">
        <div className="flex flex-col gap-2 items-center justify-start px-2 py-4 h-full ">
          ...
          <div className="flex justify-center items-center w-full ">
            <Tabs className="w-3/4 " defaultValue="signin" value={currentTab} >
              <TabsList className="grid w-full grid-cols-2 bg-transparent rounded-none">
                <TabsTrigger
                onClick={()=>setCurrentTab("signin")}
                  value="signin"
                  className="data-[state=active]:bg-transparent data-[state=active]:text-black data-[state=active]:font-semibold data-[state=active]:border-b-purple-500 p-3 transition-all duration-300 text-black text-opacity-90 border-b-2 roun-none w-full  "
                >
                  Signin
                </TabsTrigger>
                <TabsTrigger
              ...
              <TabsContent value="signup">
               ...
               <SignUpForm   setCurrentTab={setCurrentTab}  className=""   ></SignUpForm>
               </div>
